    ...
    <footer className="w-full bg-neutral-700">
      <div className="flex flex-col px-8 py-10 mx-auto max-w-[1072px] md:py-6">
        <div className="flex justify-between mb-[70px] md:mb-10 flex-wrap md:flex-nowrap gap-6">
          <a className="max-w-[140px] hidden md:block" href="/">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm font-medium leading-4 text-neutral-400">
              ...
              <li><a href="/">Политика защиты персональных данных</a></li>
            </ul>
          </div>
          <div>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-end gap-4">
                  <ul className="flex items-center gap-4">
                    <li>
                      <a className="flex justify-center items-center w-10 h-10 rounded-full bg-neutral-200" href="/" />
                    </li>
                    <li>
                      <a className="flex justify-center items-center w-10 h-10 rounded-full bg-neutral-200" href="/" />
                    </li>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <a className="text-xs font-medium leading-[15px] text-neutral-400" href="/">@Help_bot</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center">
          ...
          <div className="text-[10px] font-medium leading-3 text-neutral-400 ml-auto md:ml-0 md:text-center">
